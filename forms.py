...
class LoginForm(forms.Form):
    username = forms.CharField(max_length=USERNAME_MAX_LENGTH,
                               validators=USERNAME_VALIDATORS, help_text=USERNAME_HELP_TEXT)
    password = forms.CharField(max_length=PASSWORD_MAX_LENGTH,
                               widget=forms.PasswordInput(), validators=PASSWORD_VALIDATORS)
